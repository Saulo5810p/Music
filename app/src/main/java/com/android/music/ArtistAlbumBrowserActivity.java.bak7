        ...
        implements View.OnCreateContextMenuListener, MusicUtils.Defs
{
    ...
    public void onCreateContextMenu(ContextMenu menu, View view, ContextMenuInfo menuInfoIn) {
        ...
        if (itemtype == ExpandableListView.PACKED_POSITION_TYPE_GROUP) {
            ...
            if (mCurrentArtistName == null || mCurrentArtistName.equals(MediaFileCompat.UNKNOWN_STRING)) {
            ...
            if (mCurrentAlbumName == null || mCurrentAlbumName.equals(MediaFileCompat.UNKNOWN_STRING)) {
    ...
    static class ArtistAlbumListAdapter extends SimpleCursorTreeAdapter implements SectionIndexer {
            ...
            if (cursor != null) {
                ...
                if (mIndexer != null) {
                    ...
                    mIndexer = new MusicAlphabetIndexer(cursor, mGroupArtistIdx, 
                            mResources.getString(R.string.fast_scroll_alphabet_compat));
                }
            }
        }
        ...
        public void bindGroupView(View view, Context context, Cursor cursor, boolean isexpanded) {
            ...
            boolean unknown = artist == null || artist.equals(MediaFileCompat.UNKNOWN_STRING);
            if (unknown) {
        ...
        public void bindChildView(View view, Context context, Cursor cursor, boolean islast) {
            ...
            boolean unknown = name == null || name.equals(MediaFileCompat.UNKNOWN_STRING); 
            if (unknown) {
        ...
        protected Cursor getChildrenCursor(Cursor groupCursor) {
            ...
            class MyCursorWrapper extends CursorWrapper {
                ...
                MyCursorWrapper(Cursor c, String artist) {
                    super(c);
                    mArtistName = artist;
                    if (mArtistName == null || mArtistName.equals(MediaFileCompat.UNKNOWN_STRING)) {
