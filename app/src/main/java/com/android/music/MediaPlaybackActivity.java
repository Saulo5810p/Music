    ...
    View.OnTouchListener, View.OnLongClickListener
{
    ...
    public boolean onLongClick(View view) {
        ...
        boolean knownartist =
            (artist != null) && !MediaFileCompat.UNKNOWN_STRING.equals(artist);

        boolean knownalbum =
            (album != null) && !MediaFileCompat.UNKNOWN_STRING.equals(album);
        ...
        if (knownartist && view.equals(mArtistName.getParent())) {
            ...
            if ((song == null) || MediaFileCompat.UNKNOWN_STRING.equals(song)) {
    ...
    private void updateTrackInfo() {
        ...
        try {
            ...
            if (mService.getAudioId() < 0 && path.toLowerCase().startsWith("http://")) {
                ...
                if (MediaFileCompat.UNKNOWN_STRING.equals(artistName)) {
                    artistName = getString(R.string.unknown_artist_name);
                }
                mArtistName.setText(artistName);
                String albumName = mService.getAlbumName();
                int albumid = mService.getAlbumId();
                if (MediaFileCompat.UNKNOWN_STRING.equals(albumName)) {
