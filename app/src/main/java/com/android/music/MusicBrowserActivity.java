...
public class MusicBrowserActivity extends Activity
    ...
    /**
     * On Android 13+, posting any notification (including the playback
     * media-style notification with the lockscreen controls) requires the
     * runtime POST_NOTIFICATIONS permission.
     */
